...
const ModalExtraccion = ({ isOpen, closeModal }) => {
  ...
  return (
    <div className={`${styles.modalOverlay} fixed inset-0 flex justify-center items-center`}>
      <div className={`${styles.modalContent} bg-white w-96 p-8 rounded-lg shadow-2xl relative transform transition-all duration-500`}>
        ...
        <p className="text-gray-700 text-lg mb-6 text-center animate__animated animate__fadeIn">Las carpetas se han limpiado exitosamente. ¡Todo listo! para la extracción</p>
        ...
        <div className="flex justify-center">
          ...
          >
            Extracción de placas completada
          </button>
        </div>
      </div>
    </div>
...
export default ModalExtraccion;
