...
const GraficoMatricula = () => {
    ...
    useEffect(() => {
        axios.get('http://192.168.100.32:8000/api/usuarioActivo/')
            .then(res => setUsuariosActivos(res.data))
            .catch(err => console.error(err));

        axios.get('http://192.168.100.32:8000/api/camarUsada/')
    ...
    useEffect(() => {
        axios.get('http://192.168.100.32:8000/api/horaPico/')
...
export default GraficoMatricula;
